        ...
        <div className="container-shell">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <h1 className="mt-5 text-5xl font-bold text-white sm:text-6xl">{course.title}</h1>
              <p className="mt-4 max-w-3xl text-lg leading-8 text-white/75">{course.tagline}</p>
            ...
            <Card className="grid min-h-[320px] place-items-center bg-white/10 p-10 text-center backdrop-blur">
              <div>
                <div className="mx-auto grid h-28 w-28 place-items-center rounded-full bg-white/10 text-6xl">{course.icon}</div>
                <p className="mt-8 text-lg leading-8 text-white/75">{course.longDescription}</p>
              </div>
            </Card>
          </div>
        </div>
