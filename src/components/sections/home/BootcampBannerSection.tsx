        ...
        <div className="relative overflow-hidden rounded-[36px] bg-gradient-hero px-6 py-10 text-white shadow-glow sm:px-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Digital Courses Now Available for Direct Purchase</h2>
              <p className="mt-3 text-lg text-white/75">Choose from Data Analytics, Web Development, Mobile, AI, and Machine Learning.</p>
              <p className="mt-2 text-xl font-semibold text-brand-gold">From N180,000 to N600,000</p>
            </div>
            <div className="relative flex flex-col items-start gap-4 lg:items-end">
              <div className="rounded-full bg-brand-coral px-5 py-3 text-sm font-bold uppercase tracking-[0.16em] text-white">
                One-time payment with instant download access
              </div>
