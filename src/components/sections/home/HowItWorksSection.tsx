    ...
    <section className="bg-white py-20">
      <div className="container-shell">
        ...
        <div className="relative mt-12 grid gap-6 lg:grid-cols-4">
          ...
          {steps.map((step) => (
            <Card key={step.number} className="relative p-6 text-center">
              <div className={`mx-auto grid h-20 w-20 place-items-center rounded-full text-xl font-bold text-slate-950 ${step.color}`}>
                {step.number}
              </div>
