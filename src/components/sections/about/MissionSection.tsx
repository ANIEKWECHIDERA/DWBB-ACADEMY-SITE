    ...
    <section className="py-20">
      <div className="container-shell">
        <div className="grid gap-6 lg:grid-cols-2">
          <Card className="border-l-4 border-brand-coral p-8">
          ...
          <Card className="border-l-4 border-brand-sky p-8">
        ...
        <Card className="relative mt-6 overflow-hidden p-8 sm:p-10">
