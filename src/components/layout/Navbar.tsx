    ...
    <AnimatePresence initial={false} mode="wait">
      {mobileOpen ? (
        <motion.div
          key="mobile-menu"
          animate={{ opacity: 1 }}
          className="fixed inset-0 z-[120] bg-deep-blue sm:bg-deep-blue/95 backdrop-blur"
          exit={{ opacity: 0 }}
          initial={{ opacity: 0 }}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button aria-label="Close menu" type="button" onClick={() => setMobileOpen(false)}>
            ...
            <div className="mt-10 space-y-3">
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: 8 }}
                initial={{ opacity: 0, y: 12 }}
                transition={{ delay: 0.21, duration: 0.2 }}
              >
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden items-center gap-8 lg:flex">
              {navLinks.slice(0, 2).map((link) => (
                <NavItem key={link.to} label={link.label} light={scrolled} to={link.to} />
              ))}
